...
exports.AppComponentNgFactory = new import9.ComponentFactory('sg-app', viewFactory_AppComponent_Host0, import0.AppComponent);
...
var _View_AppComponent0 = (function (_super) {
    ...
    _View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_0 = this.renderer.createText(parentRenderNode, 'MY APP!', null);
